"""
Azure DevOps Automation Data Models
====================================

Data structures for Azure DevOps automation features.
Stored in .auto-claude/azure-devops/pr/
"""
...
class PRReviewResult:
    ...
    def save(self, azure_devops_dir: Path) -> None:
        """Save review result to .auto-claude/azure-devops/pr/"""
        pr_dir = azure_devops_dir / "pr"
    ...
    @classmethod
    def load(cls, azure_devops_dir: Path, pr_id: int) -> PRReviewResult | None:
        """Load a review result from disk."""
        review_file = azure_devops_dir / "pr" / f"review_{pr_id}.json"
...
class AzureDevOpsRunnerConfig:
    """Configuration for Azure DevOps automation runners."""
