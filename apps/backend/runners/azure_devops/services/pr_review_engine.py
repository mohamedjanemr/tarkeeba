...
class PRReviewEngine:
    ...
    def _get_review_prompt(self) -> str:
        ...
        return """You are a senior code reviewer analyzing an Azure DevOps Pull Request.
...
"""
    ...
    async def run_review(
        ...
        for file in context.changed_files[:30]:
            path = file.get("path", file.get("old_path", "unknown"))
...
"""
        ...
        client = create_client(
            ...
            spec_dir=self.azure_devops_dir,
            model=model,
        ...
        try:
            ...
            self._report_progress(
                "analyzing", 70, "Parsing review results...", pr_id=context.pr_id
            )
    ...
    def generate_summary(
        ...
        lines.append("---")
        lines.append("_Generated by Tarkeeba PR Review_")
