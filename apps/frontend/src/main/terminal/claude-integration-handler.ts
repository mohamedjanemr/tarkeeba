 ...
 * since Tarkeeba already restores terminals to their correct cwd/projectPath.
 *
...
export function resumeClaude(
  ...
  try {
    ...
    // This is more reliable than --resume with session IDs since Tarkeeba already restores
