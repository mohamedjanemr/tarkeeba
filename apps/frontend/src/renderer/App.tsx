...
export function App() {
  ...
  // GitHub setup state (shown after Tarkeeba init)
  ...
  const handleInitialize = async () => {
    ...
    try {
      ...
      if (result?.success) {
        ...
        const errorMessage = result?.error || 'Failed to initialize Tarkeeba. Please try again.';
  ...
  return (
    <ViewStateProvider>
      ...
      <div className="flex h-screen bg-background">
        ...
        {/* GitHub Setup Modal - shows after Tarkeeba init to configure GitHub */}
        {gitHubSetupProject && (
          <GitHubSetupModal
