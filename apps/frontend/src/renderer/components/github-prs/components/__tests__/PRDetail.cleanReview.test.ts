...
describe('PRDetail Clean Review Functionality', () => {
  ...
  describe('Clean Review Comment Format', () => {
    it('should format clean review comment correctly', () => {
      ...
      const cleanReviewMessage = `## ✅ Tarkeeba PR Review - PASSED
...
*This automated review found no issues. Generated by Tarkeeba.*`;

      expect(cleanReviewMessage).toContain('## ✅ Tarkeeba PR Review - PASSED');
      expect(cleanReviewMessage).toContain('**Status:** All code is good');
      expect(cleanReviewMessage).toContain(reviewResult.summary);
      expect(cleanReviewMessage).toContain('*This automated review found no issues. Generated by Tarkeeba.*');
    });
